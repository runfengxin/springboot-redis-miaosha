...
public class RedisConfig {
     ...
     */
    private void initDomainRedisTemplate(RedisTemplate redisTemplates, RedisConnectionFactory factory) {
        //如果不配置Serializer，那么存储的时候缺省使用String，如果用User类型存储，那么会提示错误User can't cast to String！
        redisTemplates.setKeySerializer(new StringRedisSerializer());
        redisTemplates.setHashKeySerializer(new StringRedisSerializer());
        redisTemplates.setHashValueSerializer(new GenericJackson2JsonRedisSerializer());
        redisTemplates.setValueSerializer(fastJson2JsonRedisSerializer());
        // 开启事务
        redisTemplates.setEnableTransactionSupport(true);
     ...
     */
//    @Bean(name = "redisUtil")
//    public RedisUtil redisUtil(RedisTemplate redisTemplates) {
//        log.info("RedisUtil注入成功！");
//        RedisUtil redisUtil = new RedisUtil();
////        redisUtil.(redisTemplates);
//        return redisUtil;
//    }
